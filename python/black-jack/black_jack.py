...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    ace_in_hand_one = value_of_card(card_one) == 1
    ace_in_hand_two = value_of_card(card_two) == 1
    if (ace_in_hand_one and value_of_card(card_two) == 10) or (ace_in_hand_two and value_of_card(card_one) == 10):
        return True
