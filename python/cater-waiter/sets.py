...
def check_drinks(drink_name, drink_ingredients):
    ...
    for ingredient in drink_ingredients:
        if ingredient in ALCOHOLS:
            is_alcohols = True
            break
    return f'{drink_name} Cocktail' if is_alcohols else f'{drink_name} Mocktail'
...
def singleton_ingredients(dishes, intersection):
    ...
    singleton = set()
    for dish in dishes:
        singleton = singleton.union(dish.difference(intersection))
    return singleton
